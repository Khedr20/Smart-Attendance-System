...
/* Set these to your desired credentials. */
  ...
  WiFiClient client;
const char *ssid = "Nokia";  //ENTER YOUR WIFI SETTINGS
const char *password = "hikmahmel";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.161.138//biometricattendance/getdata.php"; //computer IP or the server domain
